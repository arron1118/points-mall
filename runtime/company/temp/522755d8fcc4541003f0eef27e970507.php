<?php /*a:2:{s:75:"D:\phpstudy_pro\WWW\points-mall-easyadmin\app\company\view\index\index.html";i:1688983195;s:78:"D:\phpstudy_pro\WWW\points-mall-easyadmin\app\company\view\layout\default.html";i:1688630258;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;">
                        <img src="<?php echo htmlentities((isset($userInfo['head_img']) && ($userInfo['head_img'] !== '')?$userInfo['head_img']:'/static/admin/images/head.jpg')); ?>" class="layui-nav-img" width="50" height="50">
                        <cite class="adminName"><?php echo htmlentities((isset($userInfo['username']) && ($userInfo['username'] !== '')?$userInfo['username']:'')); ?></cite>
